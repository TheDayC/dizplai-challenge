...
const EventsPage: FC = () => {
  ...
  const ticketColumns = [
    { field: "name", headerName: "Name" },
    {
      field: "price",
      headerName: "Price",
      renderCell: (data: any) => `£${data.row.price}`,
    },
    {
      field: "fee",
      headerName: "Fee",
      renderCell: (data: any) => `£${data.row.fee}`,
    },
    {
      field: "type",
      headerName: "Type",
      renderCell: (data: any) => capitalize(data.row.type),
    },
    {
      field: "availability",
      ...
      renderCell: (data: any) => {
        ...
        return (
          <span
            style={{
              color: isAvailable ? palette.success.main : palette.error.main,
            }}
          >
